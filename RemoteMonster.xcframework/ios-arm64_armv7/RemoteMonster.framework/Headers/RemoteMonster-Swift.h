...
#ifndef REMOTEMONSTER_SWIFT_H
#define REMOTEMONSTER_SWIFT_H
...
+ (void)setAudioSessionConfigurationWithCategory:(AVAudioSessionCategory _Nonnull)category mode:(AVAudioSessionMode _Nonnull)mode options:(AVAudioSessionCategoryOptions)options ioBufferDuration:(NSTimeInterval)ioBufferDuration delegate:(id <RTCAudioSessionDelegate> _Nullable)delegate;
...
- (void)onReconnectWithBlock:(void (^ _Nonnull)(void))block;
/// 원격측 비디오 사이즈 변경시 호출
...
- (void)attachLocalVideoToView:(UIView * _Nonnull)view;
- (void)attachRemoteVideoToView:(UIView * _Nonnull)view;
...
@property (nonatomic, copy) NSString * _Nonnull audioType;
@property (nonatomic) BOOL audioAutoGain;
@property (nonatomic) BOOL sharding;
...
SWIFT_CLASS("_TtC13RemoteMonster10StatResult") SWIFT_DEPRECATED
